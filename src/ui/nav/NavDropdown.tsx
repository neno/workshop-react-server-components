...
export const NavDropdown = ({ items, label, urlSegment  }: INavDropdownProps) => {
  ...
  return (
    <div className="relative z-50 group">
      ...
      <ul className="absolute top-full z-10 mt-2 w-48 rounded-md rounded-t-none bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden group-hover:block">
        {items.map((item) => (
          <li key={item.id}>
