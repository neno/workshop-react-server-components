...
// 20 top-rated movies taken from The Movie Database (TMDb)
// https://api.themoviedb.org/3/movie/top_rated?api_key=00f3f32198696caff437631c007a7548&page=1
// https://api.themoviedb.org/3/movie/top_rated?api_key=00f3f32198696caff437631c007a7548&page=2

export const topRatedMovies: TmdbMovieItem[] = [
  {
    adult: false,
